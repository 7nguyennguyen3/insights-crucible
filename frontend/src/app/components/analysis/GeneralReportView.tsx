...
interface AnalysisResultsDisplayProps {
  ...
  onArgumentStructureFieldChange?: (
    field: "main_thesis",
    value: string
  ) => void;
  onArgumentStructureListChange?: (
    field: "supporting_arguments" | "counterarguments_mentioned",
    index: number,
    value: string
  ) => void;
  onArgumentStructureAddItem?: (
    field: "supporting_arguments" | "counterarguments_mentioned"
  ) => void;
  onArgumentStructureDeleteItem?: (
    field: "supporting_arguments" | "counterarguments_mentioned",
    index: number
  ) => void;
}
    ...
    <>
      {argument_structure && (
        <ArgumentStructureCard
          ...
          onFieldChange={onArgumentStructureFieldChange}
          onListChange={onArgumentStructureListChange}
          onAddItem={onArgumentStructureAddItem}
          onDeleteItem={onArgumentStructureDeleteItem}
        />
      )}
      <Accordion
        type="single"
        collapsible
        defaultValue={
          sortedResults.length > 0 ? sortedResults[0].id : undefined
        }
                  ...
                  Object.keys(section.contextual_briefing).length > 0 && (
                    <ContextualBriefingDisplay
                      ...
                      onFieldChange={(field, value) =>
                        onContextualBriefingChange(section.id, field, value)
                      }
                      ...
                      onAddItem={(field) =>
                        onContextualBriefingAddItem(section.id, field)
                      }
                      onDeleteItem={(field, index) =>
                        onContextualBriefingDeleteItem(section.id, field, index)
                      }
                    />
                  )}
              </div>
