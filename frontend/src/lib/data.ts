...
Privacy Policy for Insights Crucible
Effective Date: July 15, 2025

1. Introduction

Welcome to Insights Crucible ("we," "us," or "our"). We are committed to protecting your privacy and handling your data in an open and transparent manner. This Privacy Policy explains how we collect, use, process, and share your information when you use our website and services (collectively, the "Services").

This policy applies to all users of our Services. By using our Services, you agree to the collection and use of information in accordance with this policy.
...
Account Information: When you register for an account, we collect your name and email address. We use Google Firebase Authentication for sign-up and login, which handles your authentication securely. We do not collect or store your password.

Payment Information: When you subscribe to a paid plan, we create a customer record in Stripe, our payment processor. We redirect you to Stripe's secure checkout page to complete the transaction. We do not collect, store, or have access to your full payment card details. We only store the Stripe Customer ID associated with your account for subscription management purposes.

B. Customer Data You Process Through Our Service
This is the data you upload or submit for analysis. We are a "Data Processor" for this information.

Transcripts and Text: You may directly paste text transcripts into our Service for analysis.

Audio and Video Files: You may upload audio or video files (e.g., MP3, MP4) for transcription and analysis.

C. Information We Collect Automatically

Cookies: When you sign in, we place a persistent cookie in your browser to keep you logged in for your convenience. This cookie currently expires after seven (7) days. You can clear cookies through your browser settings at any time.

Log Data: Like most websites, our servers automatically record information ("Log Data") created by your use of the Services. This may include your IP address, browser type, operating system, and the date and time of your requests.
...
We are committed to your privacy. We do not sell your personal information or Customer Data.

We only share information with third-party service providers ("Sub-processors") who help us operate our Services. These providers are contractually obligated to protect your data and are not permitted to use it for any other purpose.
...
To manage subscriptions and process payments securely.
...
5. Processing and Retention of Your Customer Data

We have a strict policy for handling the data you upload for analysis:

Audio/Video Files: When you upload an audio or video file, it is temporarily stored in a secure Firebase Storage bucket. After the file has been processed by AssemblyAI for transcription and the analysis is complete, the original audio/video file is immediately and permanently deleted from our storage. This deletion occurs whether the analysis succeeds or fails.

Transcripts and Analysis Results: We retain the text transcript (either from your upload or from AssemblyAI) and the resulting analysis generated by our service. This data is stored securely and is accessible to you at any time through your dashboard. You have the right to delete any specific analysis result from your dashboard, which will permanently remove the associated transcript and analysis.

Account Data: We retain your account information (name, email) for as long as your account is active. If you delete your account, we will permanently delete this information in accordance with our data deletion cycle.

6. Your Data Rights and Choices (CCPA & GDPR)
...
Company: Embercore LLC
Address: jimmy@insightscrucible.com",`;
